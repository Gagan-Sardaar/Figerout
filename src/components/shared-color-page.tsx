  ...
  return (
    ...
    >
      ...
      <div className="z-10 text-center">
        <h2 className="text-2xl font-headline font-bold text-muted-foreground mb-4">ColorSnap Studio</h2>
        ...
        <Link href="/" asChild>
          <Button size="lg" className="mt-12 rounded-full h-14 px-10 text-lg font-bold bg-primary text-primary-foreground hover:scale-105 transition-transform duration-300">
